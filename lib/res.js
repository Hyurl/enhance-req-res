...
class Response {
            ...
            if (!this.type) {
                ...
                if ((_data[0] === "{" && endsWith(_data, "}"))
                    ...
                    if (startsWith(_data, "<!DOCTYPE ")) {
                        ...
                        let match = _data.match(xmlTagPattern),
                            tag = match && match[1];

                        if (tag) {
                            if (tag.match(xmlSpecial) || !~HtmlTags.indexOf(tag)) {
                                this.type = "application/xml";
                            } else {
                                this.type = "text/html";
                            }
    ...
    set lastModified(v) {
        if (v === null || null === void 0) {
            delete this.headers["last-modified"];
        } else {
    ...
    set modified(v) {
        // Keep this setter for third-party modules in order to prevent
...
class Http2Response { }
Object.assign(Http2Response.prototype, Response.prototype);
...
if (http2) {
    Object.setPrototypeOf(Http2Response, http2.Http2ServerResponse);
    Object.setPrototypeOf(
        Http2Response.prototype,
        http2.Http2ServerResponse.prototype
    );
}

exports.default = exports.Response = Response;
