...
exports.handle = (options, req) => {
    ...
    req.host = useProxy && proxy.host ? proxy.host : (req.headers.host || req.headers[":authority"]);
    req.type = req.headers["content-type"] && req.headers["content-type"].split(";")[0];
    req.encodings = req.headers["accept-encoding"] ? req.headers["accept-encoding"].split(comma) : [];
...
if (http2) {
    ...
    Object.setPrototypeOf(Http2Request.prototype, http2.Http2ServerRequest.prototype);
}
